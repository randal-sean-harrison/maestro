$(document).ready(function() {
         ...
         $("#author-dropdown").on("change", function(){
            ...
            $("#email-author").on("click", function() {
               ...
               // Final Message
               var emailMessage = "Hi" + authorFirstName[1] + "," + newline + "Below, please find the list of recent changes to your guide: " + guideTitle + newline + newline + "The LibGuides Management Team (LMT) has made these changes as part of our continuing review of guides in which we aim to ensure that all guides meet the minimum requirements for publication. Each change is described in detail below:" + newline + newline + guideTemplate + guideName + guideType + friendlyURLGuide + associatedSubjects + fiveTags + profileAllPages + noBelowProfile + noBlankPages + comments + newline + newline + "As always, if you have any questions or concerns, or would like additional training on or assistance with your guides, email the LMT at lmt-list@nd.edu, or simply reply to this email." + newline;
